...
<div id="employee_page">
    ...
    <!-- This section shows employee the current standing order waiting for fulfillment -->
    ...
    <!-- This section alows emplotyee to create an instore purchase -->
    <div id="logic_sector">
        ...
        <table class="tableStyle">
            ...
            <tr>
                <td> <input type="productNSame" class="input_text" v-model="instorePurchaseName" placeholder="Product name"> </td>
    ...
    <!-- This section shows all shifts for an employee -->
    <div id="logic_sector">
