...
<div id="customer_page">
    ...
    <!-- This section shows the customer's account info -->
    ...
    <!-- This section prompt the customer to create a cart if customer do not have one -->
    <div id="cart">
        ...
        <!-- This section display all cart items if any -->
    ...
    <!-- This section shows the customer's order history. It is hidden if customer do not have any history order -->
