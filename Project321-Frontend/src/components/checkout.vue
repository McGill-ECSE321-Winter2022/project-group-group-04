...
<div id="customer_page">
    ...
    <!-- This section shows order details -->
    <div class="section">
    ...
    <!-- This section shows a list of tiime slots that the customer can choose from -->
    ...
    <!-- This section prompts the user to enter the paymentcode to complete the order-->
