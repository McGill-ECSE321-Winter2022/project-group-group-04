...
<div id="view_timeslot">
    ...
    <!-- This section shows owner all time slots in the system -->
    ...
    <!-- This section allows the owner to create a new time slot -->
    ...
    <!-- This section allows the owner to delete a timeslot -->
