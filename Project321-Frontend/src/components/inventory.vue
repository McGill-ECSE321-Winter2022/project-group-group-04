...
<div id="inventory">
    ...
    <!-- This section will prompt the owner to add a product -->
    <h3 style="text-align:center">Add a product</h3>
    <table class="tableStyle">
        <tr>
            <td> <label> Product name</label> <input type="productName" class="input_text" v-model="newProductName" placeholder="Product name"> </td>
    ...
    <!-- This section will show owner all products with a delete button for each product -->
