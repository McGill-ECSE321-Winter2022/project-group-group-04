...
public class CartPage extends Fragment {
    ...
    public void createCart() {
        final TextView tv = (TextView) getView().findViewById(R.id.carts);
        HttpUtils.get("/carts",new RequestParams(),new JsonHttpResponseHandler(){
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                tv.setText((CharSequence) response);
            }
